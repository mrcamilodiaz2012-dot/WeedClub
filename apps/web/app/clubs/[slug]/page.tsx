...
export default async function ClubDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (error || !club) {
    ...
    if (isMock) {
      club = {
        ...
        cover_image_url: `https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1200&auto=format&fit=crop&sig=${resolvedParams.slug}`,
        lat: 40.4168,
        lng: -3.7038,
  ...
  return (
    <main className="w-full min-h-screen bg-white">
      ...
      {/* 3. Sticky Navigation y Contenido de Tabs */}
