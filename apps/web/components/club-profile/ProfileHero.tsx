      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 relative z-20 -mt-[108px] md:-mt-[139px]">
        <div className="flex flex-col items-center justify-center text-center gap-4">
          ...
          <div className="flex items-center justify-center gap-3 w-full max-w-[320px] mt-1">
            <button className="flex-1 flex items-center justify-center gap-2 bg-[#00C853] text-white font-semibold px-4 py-2.5 rounded-full hover:bg-[#00B248] transition-colors shadow-sm text-sm">
              <Heart className="w-4 h-4" />
              Seguir
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-900 font-semibold px-4 py-2.5 rounded-full hover:bg-gray-50 transition-colors shadow-sm text-sm">
              <svg viewBox="0 0 24 24" className="w-4 h-4 text-[#00C853] fill-current" xmlns="http://www.w3.org/2000/svg">
