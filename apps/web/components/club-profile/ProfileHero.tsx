  ...
  return (
    <div className="relative w-full bg-white">
      ...
      <div className="relative bg-white rounded-t-[32px] -mt-6 px-4 md:px-8 pt-6 pb-2 z-20 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
        ...
        <div className="absolute -top-6 right-5 md:right-8 z-30 flex items-center gap-3">
          {/* Seguir Button */}
          <button className="h-[48px] px-6 rounded-full bg-black text-white font-bold text-[14px] flex items-center justify-center hover:scale-105 transition-transform shadow-[0_8px_20px_rgba(0,0,0,0.25)] tracking-wide">
            Seguir
          </button>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-[48px] h-[48px] rounded-full bg-[#1ed760] text-black flex items-center justify-center hover:scale-105 transition-transform shadow-[0_8px_20px_rgba(30,215,96,0.3)]"
          >
            <svg 
