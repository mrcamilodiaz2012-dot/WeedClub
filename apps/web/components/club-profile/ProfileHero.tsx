      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 relative z-20 -mt-[90px] md:-mt-[125px]">
        <div className="flex flex-col items-center justify-center text-center gap-4">
          ...
          <div className="flex items-center justify-center gap-3 w-full max-w-[320px] mt-1">
            <button className="flex-1 flex items-center justify-center gap-2 bg-gray-900 text-white font-semibold px-4 py-2.5 rounded-full hover:bg-gray-800 transition-colors shadow-sm text-sm">
