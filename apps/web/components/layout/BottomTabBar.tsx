...
export function BottomTabBar() {
  ...
  return (
    <div className="fixed bottom-6 left-4 right-4 h-[64px] z-50 flex items-center justify-between px-6 bg-white/85 backdrop-blur-2xl rounded-[32px] shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
