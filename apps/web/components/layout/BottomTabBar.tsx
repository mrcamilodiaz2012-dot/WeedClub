...
export function BottomTabBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full z-50 flex items-center justify-between px-6 h-[calc(60px+env(safe-area-inset-bottom))] pb-[env(safe-area-inset-bottom)] bg-white border-t-[0.5px] border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.02)]">
